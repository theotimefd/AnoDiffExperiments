...
def train_epoch(epoch, best_val_epoch_loss, best_val_epoch):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        if val_epoch_loss < best_val_epoch_loss:
            ...
            torch.save(
                model.state_dict(),
                os.path.join(ROOT_DIR+"AnoDiffExperiments/best_models/experiment_3", "exp_3_4_best_model.pth"),
            )
...
if RESUME_TRAINING == False:
    ...
    os.makedirs(ROOT_DIR+"AnoDiffExperiments/tensorboard/exp_3_4", exist_ok=True)
    writer = SummaryWriter(ROOT_DIR+"AnoDiffExperiments/tensorboard/exp_3_4")
