...
def launch_train_full_volume(args):
    ...
    train_datalist = [
        ...
        for adc_path, flair_path, t1_path in zip(train_images_adc, train_images_flair, train_images_t1)
    ]
    val_datalist = [
        {"adc": adc_path, "flair": flair_path, "t1": t1_path}
        for adc_path, flair_path, t1_path in zip(val_images_adc, val_images_flair, val_images_t1)
    ]
