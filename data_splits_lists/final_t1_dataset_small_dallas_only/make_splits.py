...
# only keep files that have all three versions, i.e. the intersection of the three lists
...
filelist_dallas_t1 = [final_t1_dataset_dallas + item for item in filelist_dallas_t1 if '_'.join(item.split('_')[:2]) in final_filelist_names_intersection]
