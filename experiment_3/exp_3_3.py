...
sys.path.append(ROOT_DIR+"AnoDiffExperiments/AnoDDPM")
sys.path.append("..")
...
model = DiffusionModelUNet(
    ...
    num_head_channels=(0, 64, 128, 128),
)
model.to(device)
...
def train_epoch(epoch, best_val_epoch_loss, best_val_epoch):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        if val_epoch_loss < best_val_epoch_loss:
            ...
            torch.save(
                model.state_dict(),
                os.path.join(ROOT_DIR+"AnoDiffExperiments/best_models/experiment_3", "exp_3_3_best_model.pth"),
            )
...
if RESUME_TRAINING == False:
    ...
    os.makedirs(ROOT_DIR+"AnoDiffExperiments/Tensorboard/exp_3_3", exist_ok=True)
    writer = SummaryWriter(ROOT_DIR+"AnoDiffExperiments/Tensorboard/exp_3_3")
    ...
    model.load_state_dict(torch.load(os.path.join(ROOT_DIR+"AnoDiffExperiments/best_models/experiment_3", "exp_3_3_best_model.pth"), map_location=DEVICE_TYPE))
