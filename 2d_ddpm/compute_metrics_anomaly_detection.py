...
def launch_compute_metrics_anomaly_detection(args):
    ...
    NOISE_INTERVAL = args.compute_metrics_reconstruction["noise_interval"]
    NOISE_RANGE = range(NOISE_MIN,NOISE_MAX,NOISE_INTERVAL)
    ...
    metrics_result_text += f"Best IOU (large group): {best_iou:.4f}\n"
    ...
    metrics_result_text += f"Best IOU (medium group): {best_iou:.4f}\n"
    ...
    metrics_result_text += f"Best IOU (small group): {best_iou:.4f}\n"
