...
model.load_state_dict(torch.load(os.path.join(ROOT_DIR+"AnoDiffExperiments/Best_models/2d_ddpm_tutorial", "Experiment_1-2_ADC_best_metric_model_dallas_and_hcp_ya_3slices_per_patient.pth"), map_location=DEVICE_TYPE))
model.eval()
