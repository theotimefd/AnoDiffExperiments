...
def launch_compute_select_params_cpu(args):
    ...
    if args.dataset["test"] == "brats":
        ...
        best_params_df = pd.DataFrame({
            'parameter': ['num_timesteps', 'threshold', 'median_filter_size', 'erosion_dilation_iterations', 'binary_fill_holes'],
            'value': [best_num_timesteps, best_threshold, best_median_filter_size, best_erosion_dilation_iterations, best_binary_fill_holes]
        })
    ...
    if args.dataset["test"] == "isles": # TODO: finir pour isles et changer les noms de tous les fichiers isles pour qu'ils aient tous le même nom
        ...
        iou_scores_df_large_group, dice_scores_df_large_group = compute_select_params_multithreaded(args, ANOMALY_MAPS_DIR_SELECT_PARAMS, ROOT_DIR+"datasets/TODO/TODO/", len(test_anomaly_large_images_select_params), num_timesteps_to_try, thresholds_to_try, median_filter_sizes_to_try, erosion_dilation_iterations_to_try, binary_fill_holes_to_try)
        ...
        best_params_df = pd.DataFrame({
            'parameter': ['num_timesteps', 'threshold', 'median_filter_size', 'erosion_dilation_iterations', 'binary_fill_holes'],
            'value': [best_num_timesteps_large_group, best_threshold_large_group, best_median_filter_size_large_group, best_erosion_dilation_iterations_large_group, best_binary_fill_holes_large_group]
        })
        ...
        best_params_df = pd.DataFrame({
            'parameter': ['num_timesteps', 'threshold', 'median_filter_size', 'erosion_dilation_iterations', 'binary_fill_holes'],
            'value': [best_num_timesteps_medium_group, best_threshold_medium_group, best_median_filter_size_medium_group, best_erosion_dilation_iterations_medium_group, best_binary_fill_holes_medium_group]
        })
        ...
        best_params_df = pd.DataFrame({
            'parameter': ['num_timesteps', 'threshold', 'median_filter_size', 'erosion_dilation_iterations', 'binary_fill_holes'],
            'value': [best_num_timesteps_small_group, best_threshold_small_group, best_median_filter_size_small_group, best_erosion_dilation_iterations_small_group, best_binary_fill_holes_small_group]
        })
