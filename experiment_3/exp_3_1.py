...
def train_epoch(epoch, best_val_epoch_loss, best_val_epoch):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        if val_epoch_loss < best_val_epoch_loss:
            ...
            torch.save(
                model.state_dict(),
                os.path.join(ROOT_DIR+"AnoDiffExperiments/Best_models/2d_ddpm_tutorial", "Experiment_3-1_ADC_2d_ddpm_simplex_noise_best_metric_model_dallas_and_hcp_ya.pth"),
            )
...
if RESUME_TRAINING == False:
    ...
    writer = SummaryWriter(ROOT_DIR+"AnoDiffExperiments/Tensorboard/Experiment_3-1_ADC_2d_ddpm_simplex_noise")
    ...
    model.load_state_dict(torch.load(os.path.join(ROOT_DIR+"AnoDiffExperiments/Best_models/2d_ddpm_tutorial", "Experiment_3-1_ADC_2d_ddpm_simplex_noise_best_metric_model_dallas_and_hcp_ya.pth"), map_location=DEVICE_TYPE))
